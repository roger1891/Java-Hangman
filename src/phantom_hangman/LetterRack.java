...
public class LetterRack extends JPanel {
    ...
    /**
     * the type of image (.jpg, .png, etc to indicate the period)
     */
     ...
     * letter image directory, and letter image type
    ...
    private void buildRack() {
        ...
        //add random values to fill hte remainder of the rack
        for(; i < CAPACITY; i++) {
     ...
     * @param 1 the TileListener to be added
     */
